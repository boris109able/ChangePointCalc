...
-29.146 -12.289   0.745  10.476  45.071 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)  -0.5024     4.7432  -0.106    0.916    
x             1.5193     0.1619   9.385 1.94e-12 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 16.52 on 48 degrees of freedom
Multiple R-squared:  0.6473,	Adjusted R-squared:  0.6399 
F-statistic: 88.08 on 1 and 48 DF,  p-value: 1.938e-12
\end{Soutput}
\end{Schunk}
...
1     48 13098                           
2     47 12860  1    238.18 0.8755 0.3543
3     46 12514  1    345.37 1.2695 0.2657
\end{Soutput}
\begin{Sinput}
> class(foo)
\end{Sinput}
...
\begin{Soutput}
  Res.Df      RSS Df Sum of Sq         F    Pr(>F)
1     48 13097.69 NA        NA        NA        NA
2     47 12859.51  1  238.1791 0.8755089 0.3543211
3     46 12514.14  1  345.3727 1.2695359 0.2656974
\end{Soutput}
\end{Schunk}

SGLLogitcalc <-function(data, gamma = 0.9, thresh = 0.01, nlam = 20, lambdas = NULL, beta.naught = rep(0,ncol(data$x)), inner.iter = 1000, outer.iter = 1000, outer.thresh = 0.01, alpha = 0.8, step = 1, reset = 10,  min.frac = 0.05, verbose = FALSE)
{
